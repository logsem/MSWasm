...
From MSWasm Require Import array.
From MSWasm Require Import common memory memory_list segment_list.
From MSWasm Require Export numerics bytes.
From mathcomp Require Import ssreflect ssrfun ssrnat ssrbool eqtype seq.
From compcert Require common.Memdata.
From MSWasm Require Import handle.
...
Inductive memory_event :=
  ...
  | ME_salloc : handle -> memory_event
  | ME_sfree : handle -> memory_event
  | ME_trap : memory_event
  .
