...
From MSWasm.iris.helpers.prelude Require Import iris_wasm_lang_properties iris_reduce_properties iris_split_reduce first_instr.
...
From MSWasm Require Import handle operations opsem properties.
  ...
  { repeat rewrite wp_unfold /wp_pre /=. rewrite Hetov.
    ...
    { apply prim_step_obs_efs_empty in HStep'' as Hemp. destruct Hemp as [me Hemp]. inversion Hemp;subst;clear Hemp.
      ...
      { apply to_val_local_inv in Hetov2 as Heq.
        ...
        iDestruct ("Hes2" with "[$]") as "Hes2".
        iDestruct ("Hes2" with "[]") as "Hes2".
        { iPureIntro. apply iris.of_to_val in HLI. rewrite HLI. eauto. }
        iFrame.
      }
