...
Require Import Coq.Strings.String Coq.Strings.BinaryString.
From compcert Require Import Floats.
From mathcomp Require Import ssreflect ssrfun ssrnat ssrbool eqtype seq.
Require Import Coq.Init.Decimal.
From MSWasm Require Import bytes_pp datatypes interpreter.
Require BinNatDef.
From MSWasm Require Import ansi list_extra.
...
Fixpoint pp_basic_instruction (i : indentation) (be : basic_instruction) : string :=
  ...
  | BI_segload t =>
      indent i (pp_value_type t ++ ".segload" ++ newline)
  ...
  | BI_segstore t =>
      indent i (pp_value_type t ++ ".segstore" ++ newline)
  | BI_current_memory =>
