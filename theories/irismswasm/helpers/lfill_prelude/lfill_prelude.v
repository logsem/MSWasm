...
From MSWasm Require Import  common operations opsem properties list_extra stdpp_aux.
From MSWasm.iris.helpers Require Export lfill_extension.
...
Lemma lfilled_return_and_reduce s f es LI me s' f' es' i lh vs k lh' :
  reduce s f es me s' f' es' ->
  const_list vs ->
...
Lemma llfill_call_host_and_reduce s f es LI me s' f' es' lh lh' tf h cvs vs :
  reduce s f es me s' f' es' ->
  const_list vs ->
...
Lemma lfilled_call_host_and_reduce s f es LI me s' f' es' i lh vs k lh' tf h cvs:
  reduce s f es me s' f' es' ->
  const_list vs ->
