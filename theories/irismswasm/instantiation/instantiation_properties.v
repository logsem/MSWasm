...
From MSWasm Require Import datatypes operations properties opsem instantiation stdpp_aux type_preservation type_progress .
From stdpp Require Import list fin_maps gmap.
From MSWasm.iris.helpers Require Import iris_reduce_properties.
...
Proof.
  ...
  { inversion H; subst; clear H; try by repeat destruct vs => //.
    ...
    all: try by repeat (destruct vcs ; inversion H0).
    by exists v.
  }
  { move/lfilledP in H.
...
Proof.
  ...
  move/eqP in Hig2.
  move/andP in Ham1; move/andP in Ham2.
  destruct Ham1 as [Ham1 Hia1].
  destruct Ham2 as [Ham2 Hia2].
  move/eqP in Hia1.
  move/eqP in Hia2.
   move/andP in Ham1; move/andP in Ham2.
  destruct Ham1 as [Ham1 His1].
  destruct Ham2 as [Ham2 His2].
  move/eqP in His1.
  move/eqP in His2.
  move/andP in Ham1; move/andP in Ham2.
