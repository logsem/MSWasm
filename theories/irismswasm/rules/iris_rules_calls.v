...
From MSWasm.iris.helpers.prelude Require Import iris_wasm_lang_properties first_instr.
From MSWasm Require Import datatypes operations opsem properties handle.
...
Context `{!wasmG Σ}.
  ...
  Proof.
    ...
    { eapply rm_silent, r_invoke_native with (ts:=ts) ;eauto.
