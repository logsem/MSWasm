...
From MSWasm Require Import stdpp_aux datatypes operations properties opsem typing inj_div.
...
Section fundamental.
  ...
  Proof.
    ...
    iDestruct "Hvh" as (h) "(-> & [%Hval | (%γ & %base' & %bound' & %base_all & %bound_all & %q & %Hq & #Hw & %Hbase_all & %Hbase & %Hbound_all & %Hbound & #Hinv)])".
    ...
    apply N.ltb_ge in Hbounds.
      ...
      destruct x as [[base0 bound0] | ] ; first iDestruct "Htok" as "(-> & -> & Htok)". 
            ...
            -- (* Case 1: the place where we wrote to memory is before addr *)
              ...
              apply N.leb_le in Hlo.
               ...
               ++ iRight.
                  ...
                  erewrite length_bits => //.
                  rewrite Nat.add_comm Nat.sub_add; last lia.
                  done.
        ...
        + iNext. iExists _. iFrame "Hss". iSplit.
          ...
          * (* We must now restore the invariant on all stored handles to be valid *)
            ...
            -- (* Case 1: the place where we wrote to memory is before addr *)
              ...
              { 
                apply (N.le_sub_le_add_r _ addr base') in Hlo0.
