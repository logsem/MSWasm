...
From MSWasm.iris.rules Require Import iris_rules iris_example_helper.
From MSWasm.iris.helpers.lfill_prelude Require Import lfill_extension.
From MSWasm Require Import operations properties.
...
#[export] Hint Mode DecomposeLocal ! - - - - - : typeclass_instances.
...
#[export] Hint Mode DecomposeLabel ! - - - - - : typeclass_instances.
...
#[export] Hint Mode DecomposeBase ! ! - - : typeclass_instances.
...
#[export] Hint Mode BuildCtx - - ! ! : typeclass_instances.

Class DeconstructCtx i lh es LI :=
  { MkDeconstruct: lfilled i lh es LI }.

#[export] Hint Mode DeconstructCtx - - ! - : typeclass_instances.
...
Ltac deconstruct_ctx :=
  ...
  | |- context [ (WP ?es @ ?s; ?E CTX ?i; ?lh {{ ?P }})%I ] =>
      iApply (@wp_deconstruct_ctx _ _ _ es); 
