...
From Coq Require Import Program.Equality NArith (* Omega *) PeanoNat BinInt.
From MSWasm Require Export operations typing datatypes_properties typing opsem properties type_preservation.
Require Import Lia.
...
Proof.
  ...
  remember H3 as H500. clear HeqH500.
...
Proof.
  ...
  - (* Segload *)
    ...
    destruct (Nat.leb (nat_of_bin (h.(offset)) + t_length t) (nat_of_bin h.(bound))) eqn:Hhi;
      [ apply PeanoNat.Nat.leb_le in Hhi | apply PeanoNat.Nat.leb_gt in Hhi].
