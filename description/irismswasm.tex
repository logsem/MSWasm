...
When reducing a native call, the code of the closure is placed inside a \KK{local} and inside a \xxWblock, meaning one can use a \( \xxWbr{i} \) instruction with a carefully chosen \( i \) instead of a \xxWreturn instruction.
